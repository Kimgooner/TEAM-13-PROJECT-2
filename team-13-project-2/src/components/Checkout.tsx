  ...
  return (
    <div>
      ...
      <div className="space-y-3">
        ...
        <input type="text" placeholder="주소" className="w-full border p-2 rounded" />
        <input type="text" placeholder="우편번호" className="w-full border p-2 rounded" />
      </div>
      ...
      <button className="mt-4 w-full bg-black text-white py-2 rounded hover:bg-gray-800">결제하기</button>
    </div>
  );
}
